...
\input{sections/ch-background-gm}
\clearpage
...
\appendix
\pagestyle{appendix} % use the fancy page style again from here

\includepdf[pages=1,pagecommand={\pagestyle{fancy}\chapter{GM Evaluation Map Creator\label{appendix:gm-evaluation-map-creator}}},offset=0 -10cm]{sections/evaluation-form-map-creator.pdf}
\markboth{GM Evaluation Map Creator}{GM Evaluation Map Creator} % ensure the correct name appears in the header and footer
\includepdf[pages=2-,pagecommand={\pagestyle{fancy}}]{sections/evaluation-form-map-creator.pdf}

\includepdf[pages=1,pagecommand={\pagestyle{fancy}\chapter{GM Evaluation End User\label{appendix:gm-evaluation-end-user}}},offset=0 -10cm]{sections/evaluation-form-end-user.pdf}
\markboth{GM Evaluation End User}{GM Evaluation End User} % ensure the correct name appears in the header and footer
\includepdf[pages=2-,pagecommand={\pagestyle{fancy}}]{sections/evaluation-form-end-user.pdf}
